...
function activatePage(pageNumber) {
   ...
   ========================================= */
    ...
    const currentPageNumber = document.querySelector(
        "#current-page-number"
    );

    const pageProgressFill = document.querySelector(
        "#page-progress-fill"
    );
    ...
    if (pageProgressFill) {
        ...
        const progress =
            (pageNumber / pageManager.totalPages) * 100;

        pageProgressFill.style.width =
            `${progress}%`;
    }
